...
@Configuration
public class SnapshotKafkaClientConfig {

    private final String kafkaUrlServer;

    public SnapshotKafkaClientConfig(@Value("${app.kafka.servers:localhost:9099}") String kafkaUrlServer) {
    ...
    KafkaClient getKafkaClient() {
        return new KafkaClient() {
            ...
            private void initConsumer() {
                ...
                config.setProperty(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, "ru.deserializer.SnapshotsDeserializer");
                config.setProperty(ConsumerConfig.GROUP_ID_CONFIG, "consumer-snapshots-1");
